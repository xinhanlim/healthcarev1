    ...
    return (
        <header className="fixed w-full w-full z-[999]">
            <nav className="flex items-center justify-between px-6 sm:px-[5%] xl:py-8 3xl:py-[7%] py-5 ">
                ...
                <ul className="hidden text-sm md:flex font-medium lg:text-base gap-x-4 uppercase">
                    ...
                    <li className="inline-block w-fit px-4 py-2 bg-[#282828]">
                        <button type="button" className="uppercase text-[#FBFBFB]" >Get A Demo </button>
                    </li>
