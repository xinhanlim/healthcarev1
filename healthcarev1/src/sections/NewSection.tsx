    ...
    <section id="news" className="relative z-60 body-cover">
      ...
      <div className="h-full w-full pt-18 flex flex-col sm:pb-20 sm:px-[5%] px-6 sm:pt-20">
        ...
        <motion.div
          ...
          transition={{ duration: 0.8 }}
        >
          <h1 className="text-h4 sm:text-h6 pt-4 pb-8 leading-none tracking-tighter ">
            Feature News
          </h1>
        </motion.div>
        ...
        <motion.div
          ...
          transition={{ duration: 0.8 }}
        >
          <h1 className="text-h1 leading-none tracking-tighter section-header pt-24 ">
            <span aria-hidden="true">{'//'}</span> Partners
          </h1>
        </motion.div>
        ...
        <div className=" grid sm:grid-cols-4 grid-cols-2 gap-6 pb-16 sm:pt-16">
          <PartnersCard image="partners/nus.png" />
          <PartnersCard image="partners/cgh.png" />
          <PartnersCard image="partners/sgh.png" />
          <PartnersCard image="partners/nuhs.png" />
          <PartnersCard image="partners/singhealth.png" />
          <PartnersCard image="partners/esg.png" />
        </div>
      </div>
    </section>
  )
