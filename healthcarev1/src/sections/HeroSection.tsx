...
export default function HeroSection() {
    return (
        <section className="h-svh w-full flex flex-col justify-between sm:pb-20 sm:px-[5%] px-6 pt-24 ">
            ...
            <div className="z-20 mix-blend-normal flex sm:flex-row flex-row-reverse justify-between w-full pb-10">
                ...
                <div className="flex flex-col justify-between max-w-[60%]">
                    <h1 className="sm:mix-blend-normal sm:text-[#282828] pb-10 text-h1 sm:text-h4 py-1 sm:py-10 leading-none tracking-tighter sm:max-w-[90vh]">Trusted respiratory technology for hospitals, clinics, and care providers worldwide.</h1>
                   <NavBtn/>
                </div>
            </div>
